...
interface Props {
    ...
    type?: KeyboardType;
    onEnd?: () => void;
    fontSize?: number; // Thêm prop fontSize
}

const InputComponent = (props: Props) => {
    const { value, onChange, affix, suffix, placeholder, isPassword, allowClear, type, onEnd, fontSize = 16 } = props;
    ...
    return (
        <View style={[styles.inputContainer]}>
            {affix}
            <TextInput
                style={[styles.input, globalStyles.text, { fontSize }]} // Sử dụng fontSize từ props
                value={value}
